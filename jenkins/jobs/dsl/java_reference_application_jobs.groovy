...
buildAppJob.with {
    ...
    scm scmProvider.get(projectScmNamespace, referenceAppgitRepo, "*/master", "mdop-jenkins-master", null)
...
regressionTestJob.with {
    ...
    scm scmProvider.get(projectScmNamespace, regressionTestGitRepo, "*/master", "mdop-jenkins-master", null)
    wrappers {
        preBuildCleanup()
        injectPasswords()
        maskPasswords()
