...
// Variables
def environmentTemplateGitRepo =  "mdop-cartridge-java-environment-template"
...
The reference application deploy job is expecting the default environment to be available.''')
    ...
    scm scmProvider.get(projectScmNamespace, environmentTemplateGitRepo, "*/master", "mdop-jenkins-master", null)
    publishers {
